          ...
          {step === 'allStep' &&
            <>
              ...
              <div className="w-full md:w-fit flex flex-col items-center gap-2">
                ...
                <OrderCard key={"Aguardando"} step_type="Aguardando" technical_id={technical} setDate={setDate} setOrderSelected={setOrderSelected} type="all" orders={orders} onFindAllOrders={findAllOrders} isLoadingOrders={isLoadingOrders} onToggleDialogDeliveryPrevision={() => setIsToggleDialogUpdateDeliveryPrevision(!isToggleDialogUpdateDeliveryPrevision)} />
              </div>
          ...
          {step === 'aguardando' &&
            <>
              ...
              <div className="w-full flex flex-col items-center gap-2">
                ...
                <OrderCard key={"Aguardando"} step_type="Aguardando" technical_id={technical} setDate={setDate} setOrderSelected={setOrderSelected} type="single" orders={orders} onFindAllOrders={findAllOrders} isLoadingOrders={isLoadingOrders} onToggleDialogDeliveryPrevision={() => setIsToggleDialogUpdateDeliveryPrevision(!isToggleDialogUpdateDeliveryPrevision)} />
              </div>
            </>
          }
          ...
          {step === 'finalizado' &&
            <>
              ...
              <div className="w-full flex flex-col items-center gap-2">
                ...
                <OrderCard key={"Finalizado"} step_type="Finalizado" technical_id={technical} setDate={setDate} setOrderSelected={setOrderSelected} type="single" orders={orders} onFindAllOrders={findAllOrders} isLoadingOrders={isLoadingOrders} onToggleDialogDeliveryPrevision={() => setIsToggleDialogUpdateDeliveryPrevision(!isToggleDialogUpdateDeliveryPrevision)} />
              </div>
            </>
          }
        </div>
